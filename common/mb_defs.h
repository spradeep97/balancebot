...
#define WHEEL_BASE                  0.212 // wheel separation distance in meters
...
#define DSM_TURN_CH               4 // left stick - sideways motion
#define DSM_DRIVE_CH              3 // right stick - forward/backward motion
#define DSM_MAN_CH                5 // flight mode switch
...
#define DR_GEAR                    0.1  // Multiplier for fwd_joystick position
#define HEADING_GEAR               0.1 // Multiplier for heading
#define DR_TRAJ_GEAR               0.1 // Multiplier for fwd motion in traj tracking
#define PRINTF_HZ                  10 // rate of print loop
#define RC_CTL_HZ                  25 // rate of RC data update
#define TAU_S                      0.5740 // stall torque (N.m)
#define OMEGA_NL                   4.744 // no load speed (rad/s)
#endif
